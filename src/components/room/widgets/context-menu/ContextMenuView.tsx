...
export const ContextMenuView: FC<ContextMenuViewProps> = props =>
{
    ...
    const updatePosition = useCallback((bounds: NitroRectangle, location: { x: number, y: number }) =>
    {
        ...
        const maxLeft = ((GetStage().stage.width - elementRef.current.offsetWidth) - SPACE_AROUND_EDGES);
        const maxTop = ((GetStage().stage.height - elementRef.current.offsetHeight) - SPACE_AROUND_EDGES);
