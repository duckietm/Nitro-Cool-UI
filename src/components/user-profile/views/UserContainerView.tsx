import { RequestFriendComposer, UserProfileParser } from '@nitrots/nitro-renderer';
import { FC, useEffect, useState } from 'react';
import { GetSessionDataManager, FriendlyTime, LocalizeText, SendMessageComposer } from '../../../api';
